        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              ...
              style={{ fontFamily: '"8-BIT WONDER", monospace' }}
              onClick={() => window.open("https://bags.fm/HvwKBXeuyHUHDRF1c6fwQGhcDV154HsNsy6CvjxHBAGS", "_blank")}
            >
              🚀 Buy $EXITS
            </Button>
            ...
            <Button
              ...
              style={{ fontFamily: '"8-BIT WONDER", monospace' }}
              onClick={() => window.open("https://x.com/exitsbags", "_blank")}
            >
              🐦 Follow Us
            </Button>
            ...
            <Button
              ...
              style={{ fontFamily: '"8-BIT WONDER", monospace' }}
              onClick={() => window.open("https://t.me/exitbags", "_blank")}
            >
              💬 Telegram
            </Button>
          </div>
