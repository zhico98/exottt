...
switch (characterIndex) {
  ...
  case 2: // Ghost Spirit
    ...
    break
  case 3: // Naruto
    audioSrc = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/naruto-I1ntw0ndBxjI5Di5MJd7N9W5F55uN9.mp3" // Naruto'nun yeni ses dosyası
    break
  case 4: // Zoro
    audioSrc = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/zoro-bWGW9mnIcwTDQLhhTjOMcR1LqxswkZ.mp3" // Zoro'nun yeni ses dosyası
    break
  case 5: // Levi Ackerman
    audioSrc = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/levi-FkryyyTn9NlPD3MWIO9Sdg9DpCuWbK.mp3" // Levi'nin yeni ses dosyası
    break
  default:
    return
}
